...
class Controller extends BaseController {
    ...
    async save(req, res) {
        const ROUTE_PRIVILAGE = [PRIVILAGES.SUPER_ADMIN.VALUE]
        ...
        try {
            ...
            if (!_.isUndefined(data) && data.id) {
                this.sendResponse(req, res, RESPONSES.SUCCESS, { message: 'server_success.created_branch', data })
            } else {
    ...
    async delete(req, res) {
        ...
        try {
            ...
            if (!_.isUndefined(data)) {
                this.sendResponse(req, res, RESPONSES.SUCCESS, { message: 'server_response.resource_deleted_successfully' })
            } else {
                this.sendResponse(req, res, RESPONSES.ERROR, { message: 'server_error.try_again' })
            }
        } catch (error) {
